Namespace My
    ...
    Public Class Computer
        Public Shared ReadOnly Property TouchScreen As New TouchScreen
    End Class

    Public Class TouchScreen
        Private _injection As InputInjection
        ...
        Public Sub SendTouch(pos As (X As Integer, Y As Integer),
            ...
            Else
                ...
                End If
                pxWidth = sizeValue.Width / 2
                pxHeight = sizeValue.Height / 2
            End If
            With _injection
                Dim touch As New InjectedInputTouchInfo With {
                    .PointerInfo = New InjectedInputPointerInfo With {
                        ...
                        .PixelLocation = New InjectedInputPoint With {
                            .PositionX = pos.X, ' Y co-ordinate of touch on screen
                            .PositionY = pos.Y ' X co-ordinate of touch on screen
                        },
